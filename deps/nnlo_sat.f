...
c******************************************************************
c
c        This code computes the twobody-part of NNLOsat
...
c        only `nnlo_sat' needs to be called by the user.
...
c
c*******************************************************************
c              THIS CODE WAS ADAPTED BY A. EKSTROM.
c         THE ORIGINAL CODE WAS WRITTEN BY R. MACHLEIDT
c*******************************************************************
c*******************************************************************
c
c
...
c       inversion
c
      call dminv_sat (adminv,4,deter,ldminv,mdminv)
c
c
c
c
...
c
     ...
     1    6.000000d0,   0.0d0,    3.0000d0,  450.0d0,   0.0d0,
...
c
     ...
     *   55.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     ...
     7   -0.159822450d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    2.539367785d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    1.398365592d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.555958765d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5   -1.136095263d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.177674364d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    1.002892673d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.600716048d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.802300295d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0/
...
c
      data t1s0pp/
     7   -0.158149379d0, 0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.159822450d0, 0.0d0,    0.0000d0,    0.0d0,   0.0d0/
...
c
      data t1s0nn/
     7   -0.159150268d0, 0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' nnlo: Charge-Dependent Chiral NN Potential',
     1 ' at Order Three(NNLO)')
...
c
c
      call dgelg_sat (b,a,7,1,eps,ier)
c
...
c
c
      call dgelg_sat (b,a,15,1,eps,ier)
c
...
c
 9999 stop
      ...
      subroutine chistr_sat (icase,max,mex)
c
...
c
c
      call gset_sat (-1.d0,1.d0,nt,ct,wt)
      nnt=nt
c
c
c
...
c
      ...
      do 99 i=1,nt
      t=ct(i)
      call legp_sat (pj(1,i),pj(3,i),t,j)
      pj(2,i)=pj(1,i)*t
      pj(4,i)=pj(2,i)*t
      pj(6,i)=pj(4,i)*t
      pj(5,i)=pj(3,i)*t
...
c
 8000 return
      ...
      subroutine legp_sat (pj,pjm1,x,j)
c
c
...
c
      ...
      subroutine gset_sat(ax,bx,n,z,w)
c
c
...
c
c**********************************************************************
      subroutine dgelg_sat(r,a,m,n,eps,ier)
c
c
      implicit real*8 (a-h,o-z)
      dimension a(1),r(1)
...
c
c**********************************************************************
      subroutine dminv_sat (a,n,d,l,m)
      implicit real*8 (a-h,o-z)
